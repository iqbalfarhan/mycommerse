...
const ProductUploadMediaSheet: FC<Props> = ({ product, children }) => {
  ...
  const handleUploadMedia = () => {
    post(route('product.upload-media', product.id), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to product</SheetDescription>
        </SheetHeader>
...
export default ProductUploadMediaSheet;
