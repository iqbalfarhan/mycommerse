...
const TransactionUploadMediaSheet: FC<Props> = ({ transaction, children }) => {
  ...
  const handleUploadMedia = () => {
    post(route('transaction.upload-media', transaction.id), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to transaction</SheetDescription>
        </SheetHeader>
...
export default TransactionUploadMediaSheet;
